export const saludar = (Nombre) =>{return (`Bienvenido ${Nombre}`)};
const sumar = (x,y) => { return x+y};
export const pi=3.14;


// Solo puede haber una funcion exportada por defecto en un modulo. Aquella que más vayamos a usar.
export default sumar;



//exportacion de la variable users
